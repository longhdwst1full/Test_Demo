...
import { IUsers, IRole, ICommentators, IReqUsers } from '@/models/type';
import { Button, Form, FormInstance, Input, Select } from 'antd';
import { useEffect, useState } from 'react';

interface Props {
  dataUser?: IUsers;
  form: FormInstance<IReqUsers>;
  onFinish: (values: IReqUsers) => Promise<void>;
}
  ...
  return (
    <div>
      <Form
        ...
        autoComplete="off"
      >
        <Form.Item label="User name" name="nickname" rules={[{ required: true, message: 'Please input your User name!' }]}>
          <Input />
        </Form.Item>
        {/* <Form.Item
          label="Email"
