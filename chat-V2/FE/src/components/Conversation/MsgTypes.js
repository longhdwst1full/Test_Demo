      ...
      <Box p={1.5}
        sx={{
          backgroundColor: el.incoming
            ...
            : theme.palette.primary.mainChat,
          borderRadius: 1.5,
          width: "max-content",
        }}>
        <Stack spacing={2}>
          ...
          <Typography variant="body2"
            color={el.incoming ? theme.palette.text : "#000"}>{el.message}</Typography>
        </Stack>
      </Box>
      <MessageOptions />
    </Stack>
          ...
          <Stack p={2} spacing={3} alignItems="center" sx={{
            ...
            <Stack spacing={2}>
              ...
              <Typography variant="subtitle2"
                sx={{ color: theme.palette.primary.main1 }} component={Link}
                to="//https://www.youtube.com">www.youtube.com</Typography>
            </Stack>
            <Typography variant="body2" color={el.incoming ? theme.palette.text : "#000"}>
              {el.message}
            </Typography>
          </Stack>
        </Stack>
      ...
      <Box p={1.5}
        ...
        <Stack spacing={2}>
          <Stack p={2}
            ...
            <Typography variant="body2" color={theme.palette.text}>{el.message}
            </Typography>
          </Stack>
          <Typography variant="body2" color={el.incoming ? theme.palette.text : "#000"}>{el.reply}
          </Typography>
        </Stack>
      </Box>
      <MessageOptions />
      ...
      <Box p={1.5}
        ...
        <Stack spacing={1}>
          <img
            ...
            style={{ maxHeight: 210, borderRadius: "10px" }} />
          <Typography variant="body2"
            color={el.incoming ? theme.palette.text : "#000"}>{el.message}
          </Typography>
        </Stack>
      </Box>
      <MessageOptions />
  ...
  return (
    <>
      ...
      <Menu
        ...
        PaperProps={{
          style: {
            backgroundColor: 'white', // Màu sắc của menu
          },
        }}
      >
